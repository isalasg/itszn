...
---
### @color[brown](1.1 Conceptos básicos)
#### @color[yellow](Paradigma de programación (cont))
...
---
### @color[brown](1.1 Conceptos básicos)
#### @color[yellow](Tipo de dato (cont))
- Números enteros
...
---
### @color[brown](1.1 Conceptos básicos)
#### @color[yellow](Diagrama de flujo)
...
---
### @color[brown](1.1 Conceptos básicos)
#### @color[yellow](Lenguaje de programación)
@ul
